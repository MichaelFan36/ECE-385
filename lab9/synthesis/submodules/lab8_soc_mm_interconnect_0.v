...
module lab8_soc_mm_interconnect_0 (
	...
	wire  [106:0] aes_aes_slave_agent_rf_source_data;                                                 // AES_AES_Slave_agent:rf_source_data -> AES_AES_Slave_agent_rsp_fifo:in_data
	...
	wire  [106:0] aes_aes_slave_agent_rsp_fifo_out_data;                                              // AES_AES_Slave_agent_rsp_fifo:out_data -> AES_AES_Slave_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> AES_AES_Slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // AES_AES_Slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [15:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> AES_AES_Slave_agent:cp_channel
	...
	wire   [15:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> timer_0_s1_agent:cp_channel
	...
	wire   [15:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> keycode_s1_agent:cp_channel
	...
	wire  [105:0] aes_aes_slave_agent_rp_data;                                                        // AES_AES_Slave_agent:rp_data -> router_002:sink_data
	...
	lab8_soc_mm_interconnect_0_router_008 router_008 (
	...
	lab8_soc_mm_interconnect_0_avalon_st_adapter_006 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
